...
var CrcStream = (function (_super) {
    __extends(CrcStream, _super);
    function CrcStream() {
        _super.call(this);
        this._crc = -1;
        this.writable = true;
    }
    Object.defineProperty(CrcStream.prototype, "crc32", {
        get: function () {
            return this._crc ^ -1;
        },
        enumerable: true,
    ...
    CrcStream.prototype._write = function (data, encoding, cb) {
